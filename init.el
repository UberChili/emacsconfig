...
(doom! :input
       ...
       (go +lsp +treesit)         ; the hipster dialect
       ...
       (org +roam +modern +hugo +pretty +dragndrop)               ; organize your plain life in plain text
       ...
       (rust +lsp +treesit)       ; Fe2O3.unwrap().unwrap().unwrap().unwrap()
       ;;scala             ; java, but good
